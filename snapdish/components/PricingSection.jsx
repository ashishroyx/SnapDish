...
// Update: Import 'Show' instead of SignedIn/SignedOut
import { PricingTable, Show, SignInButton } from "@clerk/nextjs";
// Note: CheckoutButton remains in experimental but requires the latest SDK version
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        ...
        <Card className="relative border-2 border-orange-600 bg-orange-50">
          ...
          <CardFooter>
            {/* New Syntax: Replaces <SignedIn> */}
            <Show when="signed-in">
              {/* <CheckoutButton
                planId="ccplan_3AqvL2ertUDrsKX5zGek2BYH7ul"
                planPeriod="month"
                // Prop Name Update: Ensures correct redirect after purchase
